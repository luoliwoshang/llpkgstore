...
1. A [GitHub repository](https://github.com/luoliwoshang/goplus-llpkg) that stores llpkgs, along with GitHub Actions for generating llpkgs automatically.
...
*e.g.* `llgo get github.com/luoliwoshang/goplus-llpkg/cjson@v1.0.0`
...
>       // go.mod
>       require (
>             github.com/luoliwoshang/goplus-llpkg/cjson v1.1.0  // conan:cjson/1.7.18
>       )
>
>       require (
>             github.com/luoliwoshang/goplus-llpkg/zlib v1.0.0   // indirect; conan:zlib/1.3.1
>       )
>       ```
>
...
```
github.com/luoliwoshang/goplus-llpkg/cjson v0.1.0[conan:cjson/1.7.18]
```
...
*e.g.* `llgo list -m -versions cjson` or `llgo list -m -versions github.com/luoliwoshang/goplus-llpkg/cjson`:

```
github.com/luoliwoshang/goplus-llpkg/cjson v0.1.0[conan:cjson/1.7.18] v0.1.1[conan:cjson/1.7.18] v0.2.0[conan:cjson/1.7.19]
```
...
```json
{
  "Path": "github.com/luoliwoshang/goplus-llpkg/cjson",
  "Version": "v0.1.0",
...
You can use `clib` as a argument. It will be interpreted as an llpkg in llpkgstore and converted to multiple `github.com/luoliwoshang/goplus-llpkg/{clib}`. The output is the same as the results generated by modules identified as llpkgs.
...
3. This design is fully compatible with native Go modules:
    ```
    github.com/luoliwoshang/goplus-llpkg/cjson@v1.7.18
    ```
